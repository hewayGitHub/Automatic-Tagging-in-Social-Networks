...
public class FeatureSequence implements Sequence<Object>, Serializable,
		AlphabetCarrying {
	Alphabet dictionary;
	int[] features;
	int length;
	 ...
	 * 
	 * @param dict
	 *            A dictionary that maps objects in the sequence to numeric
	 *            indices.
	 * @param features
	 *            An array where features[i] gives the index in dict of the ith
	...
	private void readObject(ObjectInputStream in) throws IOException,
		...
		if(version < CURRENT_SERIAL_VERSION) throw new RuntimeException("Serial version is out of date");
