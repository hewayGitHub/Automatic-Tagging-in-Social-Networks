...
public class Alphabet implements Serializable {
	...
	Class<? extends Object> entryClass = null;

	VMID instanceId = new VMID(); // used in readResolve to identify persistent
									// instances

	public Alphabet(int capacity, Class<? extends Object> entryClass) {
		this.map = new gnu.trove.TObjectIntHashMap<Object>(capacity);
		this.entries = new ArrayList<Object>(capacity);
		this.entryClass = entryClass;

		// someone could try to deserialize us into this image (e.g., by
		// RMI).Handle this.
	...
	public Object clone() {
		...
		ret.map = (TObjectIntHashMap<Object>) map.clone();
		ret.entries = (ArrayList<Object>) entries.clone();
	...
	public boolean set(int index, Object entry) {
		if (index < entries.size()) {
			map.put(entry, index);
			entries.set(index, entry);
		} else {
			throw new IllegalArgumentException("Alphabet overflowed, index: " + index + ", size: " + entries.size());
		}
	...
	public Class<? extends Object> entryClass() {
		return entryClass;
	}
	...
	private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
		...
		map = new gnu.trove.TObjectIntHashMap<Object>(size);
		...
		entryClass = (Class<? extends Object>) in.readObject();
	...
	/**
	 * This gets called after readObject; it lets the object decide whether to
	 * return itself or return a previously read in version. We use a hashMap of
	 * instanceIds to determine if we have already read in this object.
	 * 
	 * @return
	...
	public Object readResolve() throws ObjectStreamException {
		...
		if (previous != null) {
			// System.out.println(" ***Alphabet ReadResolve:Resolving to previous instance. instance id= "
			// + instanceId);
			return previous;
		}
		if (instanceId != null) {
		...
		// System.out.println(" *** Alphabet ReadResolve: new instance. instance id= "
		// + instanceId);
		return this;
	}
}
